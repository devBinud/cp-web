...
@section('title', 'Publish Blog')
@section('page-title', 'Publish Blog')
<style>
    /* Bootstrap TagsInput */
    .bootstrap-tagsinput {
                ...
                <form action="" method="POST" id="editBlog">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 pb-2">
                                    ...
                                    <input type="text" id="metaTags" name="blogTags[]" class="form-control"
                                        data-role="tagsinput" placeholder="Enter Tags" value="{{ $blogData->blog_tags }}">
                                </div>
                                <div class="col-md-12 pb-2">
                    ...
                    <div class="col-md-12 m-2">
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary" id="editBlog1">Publish</button>
                        </div>
                    </div>
